...
var carImages = 
    [
        "images/6 series/bmw6.png",
        "images/6 series/bmw61.png",
        "images/6 series/bmw613.png"
    ];
    ...
    function onCarChange(v)
    {
        ...
        img.src = carImages[carIndex];
         ...
         if(carIndex===0){
            document.getElementById('price').innerHTML = "£ 22 500"; 
...
function sliderChanged(event)
    ...
    {
        img = document.getElementById("serie6");
...
document.getElementById("petrol").onclick=function()
{
    ...
    document.getElementById("bhp").innerHTML="478 bhp";
    document.getElementById("name").innerHTML="BMW 6 series Coupe 3.0i";
};

document.getElementById("diesel").onclick=function()
{
document.getElementById("name").innerHTML="BMW 6 series Coupe 3.0d";
document.getElementById("fueltype").innerHTML="Diesel";
document.getElementById("bhp").innerHTML="455 bhp";
};
//song theme off
