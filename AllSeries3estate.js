...
var carImages = 
    [
        "images/3 series/3estate.png",
        "images/3 series/3estate12.png",
        "images/3 series/3estate1.png",
    ];
...
function sliderChanged(event)
    ...
    {
        img = document.getElementById("serie3estate");
...
document.getElementById("petrol").onclick=function()
{
    ...
    document.getElementById("name").innerHTML="BMW 3 series Estate 2.0 i"
}

document.getElementById("diesel").onclick=function()
{
document.getElementById("name").innerHTML="BMW 3 series Estate 2.0 d"
