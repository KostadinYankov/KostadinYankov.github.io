...
var carImages = 
    [
        "images/5 series/5seresmsport.png",
        "images/5 series/5seresmsport1.png",
        "images/5 series/5seresmsport12.png",
    ];
    ...
    function onCarChange(v)
    {
        ...
        if(carIndex===0){
            document.getElementById('price').innerHTML = "£ 20 000"; 
...
function sliderChanged(event)
    ...
    {
        img = document.getElementById("serie5");
...
document.getElementById("petrol").onclick=function()
{
    ...
    document.getElementById("bhp").innerHTML="329 bhp"
    document.getElementById("name").innerHTML="BMW series 5 saloon 3.5 i"
}

document.getElementById("diesel").onclick=function()
{
document.getElementById("name").innerHTML="BMW series 5 saloon 3.5 d"
document.getElementById("fueltype").innerHTML="Diesel"
document.getElementById("bhp").innerHTML="307 bhp"
}
//song theme off
